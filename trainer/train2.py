...
train_examples = np.asarray(examples, dtype=np.float32)
...
model = tf.keras.Sequential([
    tf.keras.layers.Input(shape=train_examples.shape[1:]),
...
model.fit(x=train_examples, y=train_labels, epochs=1000)
